...
HD_PWD='C:/Users/gahym/EE4301_Labs/lab02/lab02.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab2_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab2_top.tcl -notrace
