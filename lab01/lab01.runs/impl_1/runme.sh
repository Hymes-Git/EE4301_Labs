...
HD_PWD='C:/Users/gahym/EE4301_Labs/lab01/lab01.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RISCVALU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RISCVALU.tcl -notrace
