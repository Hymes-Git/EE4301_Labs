...
HD_PWD='C:/Users/gahym/EE4301_Labs/lab01/lab01.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RISCVALU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RISCVALU.tcl
